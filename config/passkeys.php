...
return [
    ...
    */
    ...
    // No password concept exists in this app (invite -> PIN -> mandatory passkey
    // flow) so there's nothing to password-confirm. Registration access is instead
    // gated by our own onboarding flow (must be authenticated + not yet enrolled),
    // enforced in Auth\PasskeyEnrollController.
