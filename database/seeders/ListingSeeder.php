...
class ListingSeeder extends Seeder
{
    public function run(): void
    {
        $parts = [
            ...
            ['title' => '1992 Honda Civic VX Hatch', 'chassis' => 'EG', 'category' => PartCategory::Other, 'price' => '$123', 'location' => 'Topeka, KS', 'description' => 'EG hatch shell parts and trim.'],
            ['title' => 'OZ Racing Rims 115.x6 46', 'chassis' => 'CRX', 'also_fits' => ['EF', 'EG', 'Del Sol'], 'category' => PartCategory::SuspensionBrakesWheels, 'price' => '$550', 'location' => 'Topeka, KS', 'description' => 'Set of 4 vintage OZ Racing alloy rims, 4x100 bolt pattern.'],
            ...
            ['title' => 'DC2 Integra Type R Strut Tower Bar', 'chassis' => 'DC2 Integra', 'category' => PartCategory::SuspensionBrakesWheels, 'price' => '$220', 'location' => 'Rossville, KS', 'description' => 'Genuine OEM aluminum front upper strut brace.'],
            ...
            ['title' => 'Prelude BB4 4WS Rear Steering Actuator', 'chassis' => 'Prelude', 'category' => PartCategory::SuspensionBrakesWheels, 'price' => '$400', 'location' => 'Topeka, KS', 'description' => 'Tested electric 4-wheel-steering rear actuator motor and control module.'],
            ...
            ['title' => 'CRX HF Ultra-Lightweight Rear Drums', 'chassis' => 'CRX', 'category' => PartCategory::SuspensionBrakesWheels, 'price' => '$90', 'location' => 'Topeka, KS', 'description' => 'Factory aluminum/finned lightweight rear brake drum set.'],
        ];
